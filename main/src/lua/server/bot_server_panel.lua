...
if game:GetService("Players").LocalPlayer.Name == Owner then
    ...
    UIGradient.Color =
        ColorSequence.new {
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(241, 67, 90)),
        ColorSequenceKeypoint.new(0.09, Color3.fromRGB(248, 108, 68)),
        ColorSequenceKeypoint.new(0.19, Color3.fromRGB(246, 139, 67)),
        ColorSequenceKeypoint.new(0.30, Color3.fromRGB(243, 222, 67)),
        ColorSequenceKeypoint.new(0.49, Color3.fromRGB(96, 240, 75)),
        ColorSequenceKeypoint.new(0.75, Color3.fromRGB(88, 129, 246)),
        ColorSequenceKeypoint.new(0.89, Color3.fromRGB(67, 207, 207)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(37, 182, 222))
    }
    ...
    game:GetService("Players").LocalPlayer.Chatted:Connect(
        function(message)
            epic(message, game:GetService("Players").LocalPlayer.Name)
        end
    )
    TextButton.MouseButton1Click:Connect(
        function()
            epic(TextBox.Text, game:GetService("Players").LocalPlayer.Name)
        end
    )
