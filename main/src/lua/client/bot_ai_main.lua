	...
	UserSettings().GameSettings.MasterVolume = 0
		  ...
		  function execute(msg)
				...
				if file == "getinfo" then
						...
						wait(1)
						_G.getfps = false
						local GetName = "[DName]: "..game:GetService("Players").LocalPlayer.DisplayName
						local GetPing = "[Ping]: "..math.floor(game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValue())
						local GetFps =  "[Frame Rate]: "..frames
		
						game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[____"..math.random(100).."____]", "All")
						game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(GetName, "All")
						game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(GetPing, "All")
						game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(GetFps, "All")
			...
			while _G.Orbit == true do 
	            wait()
				i=i+0.05
				game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace"):FindFirstChild("Nafisiuwu").HumanoidRootPart.CFrame*CFrame.fromEulerAnglesXYZ(angle,i*int,0)*CFrame.new(0,0,rgdist) 
			  ...
			  if file == "unorbit" then
				...
				spawn(function()
					...
					char.Humanoid:MoveTo(Vector3.new(cPos.X + math.random(-180,90),cPos.Y,cPos.Z - math.random(-180,180)))
					end
				end)
			   ...
			   if file == "unrandommove" then
				...
				spawn(function()
					...
					wait()
					 game:GetService('TweenService'):create(game:GetService("Players").LocalPlayer.Character.Humanoid.RootPart,TweenInfo.new(1), {CFrame = CFrame.new(game:GetService("Workspace"):FindFirstChild("Nafisiuwu").HumanoidRootPart.Position - Vector3.new(math.random(-25,25),0.8,math.random(-25,25)))}):Play()
					end
				end)
				...
				spawn(function()
					while _G.Ladder == true do 
						wait()
					 game:GetService('TweenService'):create(game:GetService("Players").LocalPlayer.Character.Humanoid.RootPart,TweenInfo.new(0.1), {CFrame = CFrame.new(game:GetService("Workspace"):FindFirstChild("Nafisiuwu").HumanoidRootPart.Position - Vector3.new(0,-15,0))}):Play()
					end
				end)
				...
				if file == "disablerender" then
					...
					spawn(function()game:GetService("Players").LocalPlayer.PlayerGui:ClearAllChildren()end)
					game.RunService:Set3dRenderingEnabled(false)
			...
			if file == ";antiafk" then
				...
				if string.find(file, "walk") then
					  ...
					  if command.typee == "walk" then
						if (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-game:GetService("Players"):FindFirstChild("Nafisiuwu").Character.HumanoidRootPart.Position).Magnitude > 15 then
